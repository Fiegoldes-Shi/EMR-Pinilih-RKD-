                    ...
                    <div class="modal-header">
                        <h3 class="modal-title fs-5" id="exampleModalLabel">
                            <blockquote class="blockquote">
                                <p>Tambah Jadwal Kinesioterapi</p>
                            </blockquote>
                        </h3>
                    ...
                    foreach ($arrayjadwal as $datajadwal) {
                        ...
                        <tr class=''>
                                        ...
                                        <div class="modal-content text-left">
                                            <div class="modal-header">
                                                <figure class="text-left">
                                                    <blockquote class="blockquote">EDIT JADWAL KINESIOTERAPI</blockquote>
                            ...
                            <td>
                                ...
                                _CreateWindowModalDelete($datajadwal["idJadwal"], "del", "del-form", "del-button", "lg", 200, "HAPUS#JADWAL KINESIOTERAPI " . $datajadwal["idJadwal"] . "#" . $datajadwal["tanggalKegiatan"] . " - " . $datajadwal["namaProgram"], "", $datadelete, "", "32");
                                ?>
                            </td>
                        </tr>
                    <?php } ?>

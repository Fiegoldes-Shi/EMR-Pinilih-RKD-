...
<div class="row mx-2 justify-content-center mb-4">
                            ...
                            options: {
                                ...
                                scales: {
                                    x: {
                                        ...
                                        ticks: {
                                            autoSkip: false,
                                            maxRotation: window.innerWidth < 1200 ? 45 : 0,
                                            minRotation: window.innerWidth < 1200 ? 45 : 0
                                        }
                                    },
                                    y: {
                                        display: true,
                ...
                chart.data.datasets.forEach(function (dataset, i) {
                    ...
                    if (!meta.hidden) {
                        meta.data.forEach(function (arc, index) {
                            ...
                            // Beri outline putih agar selalu bisa terbaca
                            ctx.strokeStyle = '#fff';
                            ctx.lineWidth = 4;
                            ctx.strokeText(percent, textX, endY);

                            // Tuliskan warna hitam di tengahnya
                            ctx.fillStyle = '#000';
    ...
    <div class="col-12 col-md-4 mb-3">
        ...
        <script>
            ...
            var chartGoldar = new Chart(ctx, {
                ...
                plugins: [pieLabelsLinePlugin] // 👈 Aktifkan Data Labels hanya untuk chart ini
            });
        </script>
    </div>
        ...
        <div class="card text-center border border-2">
            <div class="card-body">
                <div class="d-flex justify-content-between align-items-center mb-3">
                    ...
                    <h5 class="flex-grow-1 text-center mb-0">Total Program Layanan</h5>

                    <!-- Filter -->
                    <div class="d-flex align-items-center">
                        <select id="filterMonth" class="form-select form-select-sm w-auto me-2">
                ...
                </div> <!-- End Header d-flex justify-content-between -->

        ...
        <div class="container-fluid">
            ...
            <ul class="nav-pills mt-2">
                ...
                <ul class="dropdown-menu dropdown-menu-end">
                    ...
                    <li><a class="dropdown-item" href="<?= $baseurl; ?>/admin/61"><ion-icon
                ...
                <div class="offcanvas-body mx-3 mt-3">
                    <ul class="navbar-nav me-auto mb-2">
                        <li class="nav-item mb-2">
                            <a class="nav-link active" aria-current="page" href="<?= $baseurl; ?>/admin/1">
                        ...
                        <li class="nav-item dropdown mb-2">
                            ...
                            <ul class="dropdown-menu">
                                <li><a class="dropdown-item mb-2" href="<?= $baseurl; ?>/admin/31">
                                        <i class="fa-solid fa-person-cane" style="color:black;"></i> &nbsp; Fisioterapi
                                    </a></li>
                                <li><a class="dropdown-item mb-2" href="<?= $baseurl; ?>/admin/32">
                                        <i class="fa-solid fa-people-robbery" style="color:black;"></i> &nbsp;
                                        Kinesioterapi
                                    </a></li>
                                <li><a class="dropdown-item mb-2" href="<?= $baseurl; ?>/admin/33">
                                        <i class="fa-solid fa-user-shield" style="color:black;"></i> &nbsp; Screening
                                    </a></li>
                                <li><a class="dropdown-item mb-2" href="<?= $baseurl; ?>/admin/34">
                                        <i class="fa-solid fa-person-chalkboard" style="color:black;"></i> &nbsp;
                                        Konsultasi
                                    </a></li>
                                <li><a class="dropdown-item mb-2" href="<?= $baseurl; ?>/admin/35">
                                        <i class="fa-solid fa-chalkboard-user" style="color:black;"></i> &nbsp; Edukasi
                                    </a></li>
                            </ul>
                        </li>
                        <li class="nav-item mb-2">
                            <a class="nav-link active" aria-current="page" href="<?= $baseurl; ?>/admin/41">
                                <i class="fa-solid fa-laptop-medical fa-lg" style="color:black;"></i> &nbsp; REKAM MEDIS
                            </a>
                        </li>
                        <li class="nav-item mb-2">
                            <a class="nav-link active" aria-current="page" href="<?= $baseurl; ?>/admin/51">
...
if ($posAdmin !== false && isset($segments[$posAdmin + 1]) && is_numeric($segments[$posAdmin + 1])) {
    $link = (int)$segments[$posAdmin + 1];
}
else {

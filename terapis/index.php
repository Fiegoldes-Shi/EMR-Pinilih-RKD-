...
<style>
    ...
    @media (max-width: 767px) {
        ...
        /* --- Pagination: teks tidak terpotong, tombol mudah diklik --- */
        ...
        /* --- Card detail program layanan: tidak hardcode lebar th --- */
        .card .table th {
...
<head>
    ...
    <script src="<?= $baseurl ?>/terapis/js/config.js?v=<?= time(); ?>" type="text/javascript"></script>
...
?>
    ...
    <script>
        $(document).ready(function() {
            ...
            // Otomatis mereset isi form ke 'default html value' setiap kali modal (Tambah/Edit) ditutup

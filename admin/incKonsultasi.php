...
<div class="row">
    <div class="col-12 col-md-10 col-lg-11">
        <?php
        _myHeader("KONSULTASI", "Jadwal Program Konsultasi");
        ?>
    </div>
                    ...
                    <div class="modal-header">
                        <h3 class="modal-title fs-5" id="exampleModalLabel">
                            <blockquote class="blockquote">
                                <p>Tambah Jadwal Konsultasi</p>
                            </blockquote>
                        </h3>
                        <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                    </div>
                    <form class="" method="post" action="konsultasi" enctype="multipart/form-data">
                ...
                <tbody>
                    ...
                    foreach ($arrayjadwal as $datajadwal) {
                        ...
                        <tr class=''>
                            ...
                            <td>
                                <a href="konsultasi/detail/<?php echo $datajadwal["idJadwal"]; ?>" class="btn btn-info"
                                        ...
                                        <div class="modal-content text-left">
                                            <div class="modal-header">
                                                <figure class="text-left">
                                                    <blockquote class="blockquote">EDIT JADWAL KONSULTASI</blockquote>
                                            ...
                                            <FORM method="post" enctype="multipart/form-data" action="konsultasi">
                                                <div class="modal-body">
                                                    <div class="mb-3">
                            ...
                            <td>
                                ...
                                _CreateWindowModalDelete($datajadwal["idJadwal"], "del", "del-form", "del-button", "lg", 200, "HAPUS#JADWAL KONSULTASI " . $datajadwal["idJadwal"] . "#" . $datajadwal["tanggalKegiatan"] . " - " . $datajadwal["namaProgram"], "", $datadelete, "34");
                                ?>
                            </td>
                        </tr>
                    <?php } ?>

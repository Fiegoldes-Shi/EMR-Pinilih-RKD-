...
<div class="row mx-2">
    <div class="col-12 col-md-2 col-lg-1 mb-3" style="width: min-content; align-content: center;">
        <a href="<?= $baseurl ?>/admin/konsultasi"><ion-icon name="chevron-back-outline" size="large" style="color: black;"></ion-icon></a>
    </div>
                    ...
                    foreach ($arrayhasil as $datahasil) {
                        ...
                        <tr class=''>
                            ...
                            <td>
                                ...
                                _CreateWindowModalDetil($datahasil["idHasilLayanan"], "view", "viewsasaran-form", "viewsasaran-button", "", 600, "DETAIL#HASIL KONSULTASI", "", $datadetail, "", "", "");
                                ?>
                            </td>
                            <td>
                                                ...
                                                <div class="modal-body">
                                                    ...
                                                    <div class="mb-3">
                                                        ...
                                                        <textarea class="form-control" id="saranRujukan" name="saranRujukan"
                                                            ...
                                                            id="floatingTextarea"
                                                            required><?= htmlspecialchars($datahasil["saranRujukan"] ?? ''); ?></textarea>
                                                    </div>
                                                </div>
                                                <div class="modal-footer">

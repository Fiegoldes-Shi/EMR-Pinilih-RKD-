...
$idJadwal = 0;
$posMenu = array_search('351', $segments);
...
<div class="row mx-2">
    <div class="col-12 col-md-2 col-lg-1 mb-3" style="width: min-content; align-content: center;">
        <a href="<?= $baseurl ?>/admin/35"><ion-icon name="chevron-back-outline" size="large" style="color: black;"></ion-icon></a>
    </div>
...
if (!empty($_POST["editbtn"])) {
    ...
    $datakey = ' idEdukasi = ' . $_POST["idEdukasi"] . '';
...
<div class="row mx-2">
    ...
    <div class="col-12 col-md-2 col-lg-1 mb-3">
        <button type="button" class="btn btn-warning" data-bs-toggle="modal"
            data-bs-target="#modalFormEdukasi<?= $idEdukasi; ?>">
...
<!-- Modal -->
<div class="modal fade" id="modalFormEdukasi<?= $idEdukasi; ?>" tabindex="-1" aria-labelledby="modalFormEdukasiLabel"
    aria-hidden="true">
            ...
            <div class="card-body">
                <table class="table">
                    ...
                    <tr>
                        <th>Dokumentasi</th>
                        <td>
                            <?php if (!empty($dokumentasi) && file_exists(__DIR__ . '/' . $dokumentasi)): ?>
...
if (!empty($_POST["simpanbtn"])) {
    ...
    if (!empty($_POST["idPeserta"]) && $_POST["idPeserta"] !== "baru") {
        ...
        $datavalue_peserta = array(
            $_POST["nama"],
            $_POST["asalLembaga"] === '' ? "" : $_POST["asalLembaga"],
            $_POST["jenisKelamin"],
            $_POST["usia"],

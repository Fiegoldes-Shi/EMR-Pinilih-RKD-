        ...
        <div class="modal fade" id="exampleModal" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
            <div class="modal-dialog modal-lg">
                <div class="modal-content">
                    ...
                    <form class="" method="post" action="screening" enctype="multipart/form-data">
                    ...
                    foreach ($arrayjadwal as $datajadwal) {
                        ...
                        <tr class=''>
                                ...
                                <div class="modal fade" id="formedit<?= $datajadwal["idJadwal"]; ?>" tabindex="-1"
                                    ...
                                    <div class="modal-dialog modal-lg">
                                        <div class="modal-content text-left">
                                            ...
                                            <FORM method="post" enctype="multipart/form-data" action="screening">
                                                <div class="modal-body">
                                                    <div class="mb-3">
                            ...
                            <td>
                                ...
                                _CreateWindowModalDelete($datajadwal["idJadwal"], "del", "del-form", "del-button", "lg", 200, "HAPUS#JADWAL SCREENING " . $datajadwal["idJadwal"] . "#" . $datajadwal["tanggalKegiatan"] . " - " . $datajadwal["namaProgram"], "", $datadelete, "", "33");
                                ?>
                            </td>
                        </tr>
                    <?php } ?>

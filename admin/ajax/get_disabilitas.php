...
$columns = [
    ...
    4 => 'idSubDisabilitas', // Edit
    5 => 'idSubDisabilitas'  // Delete
];
...
foreach ($data as $row) {
    ...
    $btnEdit = '<button type="button" class="btn btn-warning btn-edit" style="border-radius: 8px;" data-id="' . $row['idSubDisabilitas'] . '" title="Edit">
                    <i class="fa-regular fa-pen-to-square" style="color: #000000;"></i>
                </button>';
    $btnDelete = '<button type="button" class="btn btn-danger btn-delete" style="border-radius: 8px;" data-id="' . $row['idSubDisabilitas'] . '" title="Delete">
